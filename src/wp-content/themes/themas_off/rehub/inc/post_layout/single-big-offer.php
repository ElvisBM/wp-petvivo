                        ...
                        <div class="rh_post_layout_big_offer">
                            <div class="title_single_area">
                                <?php if(is_singular('post') && rehub_option('compare_btn_single') !='') :?>
                                    ...
                                    <div class="floatright ml10"><?php echo do_shortcode('[wpsm_compare_button'.$compare_cats.']'); ?></div> 
                                <?php endif;?>
                                <?php 
                                    $crumb = '';
                            ...
                            <div class="rh_post_layout_compare_holder mb25 <?php echo $reveal_enabled; echo $coupon_style; ?>">
                                ...
                                <div class="single_compare_right">
                                    ...
                                    <?php else :?>
                                        <div class="top_share notextshare"><?php get_template_part('inc/parts/post_share'); ?></div>
