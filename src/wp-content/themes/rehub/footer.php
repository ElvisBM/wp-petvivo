		...
		<div class="rh-container clearfix">
			<div class="footer_most_bottom">
				<div class="f_text">
					...
					<?php endif; ?>
					<?php if(rehub_option('rehub_footer_logo')) : ?><div class="floatright ml15 mr15"><img src="<?php echo rehub_option('rehub_footer_logo'); ?>" alt="<?php bloginfo( 'name' ); ?>" /></div><?php endif; ?>	
				</div>		
			</div>
		</div>
	</footer>
