...
class rehub_tabsajax_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
	    ...
	    <?php echo do_shortcode ('[wpsm_recent_posts_list show_date="'.$datefirst.'" show="6" orderby="meta_value_num" order="DESC" meta_key="'.$metafirst.'" filterpanel="'.$prepare_filter.'" nometa="1"]') ;?>
	   	</div>
