			...
			<table>
				<thead>
					<tr>
						...
						<th align="left"><?php _e( 'City', 'wcvendors-pro' ); ?> </th>
						<th align="left"><?php _e( 'District', 'wcvendors-pro' ); ?> </th>
						...
						<th colspan="5">
							...
							<?php
								...
								$file_data_row = '<tr>
									...
									<td class="city"><input type="text" placeholder="'. __( "City", "wcvendors-pro" ). '" name="_wcv_shipping_citys[]" value="'. esc_attr( $rate["city"] ) .'" /></td>
