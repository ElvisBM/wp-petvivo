...
/* 	$('.wpfepp-file-url-button').on('click', function(e){
	...
	if($('input.wpfepp-product_options-downloadable-field').is(':checked')) {
		...
		$('.wpfepp-downloadable_files-container').show();
	} else {
		$('input.wpfepp-product_options-external-field').prop("disabled", false);
		$('.wpfepp-downloadable_files-container').hide();
	}
	$('input.wpfepp-product_options-downloadable-field').change(function() {
		if(this.checked) {
			$('input.wpfepp-product_options-external-field').prop("disabled", true);
			$('.wpfepp-downloadable_files-container').show();
		} else {
	...
	if($('input.wpfepp-product_options-external-field').is(':checked')) {
		$('input.wpfepp-product_options-virtual-field').prop("disabled", true);
		$('input.wpfepp-product_options-downloadable-field').prop("disabled", true);
		$('.wpfepp-product_external-container').show();
	} else {
		$('input.wpfepp-product_options-virtual-field').prop("disabled", false);
		$('input.wpfepp-product_options-downloadable-field').prop("disabled", false);
		$('.wpfepp-product_external-container').hide();
	}
	$('input.wpfepp-product_options-external-field').change(function() {
		if(this.checked) {
			$('input.wpfepp-product_options-virtual-field').prop("disabled", true);
			$('input.wpfepp-product_options-downloadable-field').prop("disabled", true);
			$('.wpfepp-product_external-container').show();
