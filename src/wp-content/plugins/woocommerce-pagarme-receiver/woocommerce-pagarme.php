...
if ( ! class_exists( 'WC_Pagarme' ) ) :
	...
	class WC_Pagarme {
		...
		public function add_gateway( $methods ) {
			...
			$methods[] = 'WC_Pagarme_Split_Gateway';
		...
		public function plugin_action_links( $links ) {
			...
			$split   = 'WC_Pagarme_Split_Gateway';
			...
			$plugin_links[] = '<a href="' . esc_url( admin_url( 'admin.php?page=wc-settings&tab=checkout&section=' . $split ) ) . '">' . __( 'Split Settings', 'woocommerce-pagarme' ) . '</a>';
