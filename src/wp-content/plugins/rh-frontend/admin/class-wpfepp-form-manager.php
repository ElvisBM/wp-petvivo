...
class WPFEPP_Form_Manager
{
	...
	private function set_defaults(){
		...
		$this->defaults['extended'] = array(
			'map_start_location'		=> '',
			'start_geo_lat'		=> '51.483137',
			'start_geo_long'	=> '-0.007',
			'enable_city_suggest' => false,
			'enable_map' 		=> true,
		);
	}
	...
	private function generate_default_form_fields(){
		...
		foreach ($this->post_types as $post_type) {
			$default_fields = array(
					...
					'formatting' 	=> array( 'type' => 'post_formats', 'widget_label' => __('Formats', 'wpfepp-plugin'), 'label' => __('Formats', 'wpfepp-plugin'), 'enabled' => true, 'required'=> false, 'width' => '', 'fallback_value' => '', 'prefix_text' => '' ),
				);
				if($post_type == 'product') {
					$default_fields_wc = array(
						...
						'product_options' => array('type' => 'product_options', 'widget_label' => __('Product Options', 'wpfepp-plugin'), 'label' => __('Product Options', 'wpfepp-plugin'), 'enabled' => false, 'required'=> false, 'fallback_value' => '', 'prefix_text' => '')
					);
			...
			foreach ($taxonomy_objects as $taxonomy) {
				$excluded_taxonomy = array('post_format', 'product_type', 'product_shipping_class');
